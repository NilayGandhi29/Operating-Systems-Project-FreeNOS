...
{
    //WARNING("##############inside ProcessShares::ProcessShares()");
    m_pid    = pid;
    m_memory = ZERO;
}
...
{
    //WARNING("##############inside ProcessShares::getProcessID()");
    return m_pid;
}

MemoryContext * ProcessShares::getMemoryContext()
{
    //WARNING("##############inside ProcessShares::getMemoryContext()");
    return m_memory;
}

ProcessShares::Result ProcessShares::setMemoryContext(MemoryContext *ctx)
{
    //WARNING("##############inside ProcessShares::setMemoryContext()");
    m_memory = ctx;
    return Success;
}
...
ProcessShares::Result ProcessShares::createShare(ProcessID pid,
                                                 ...
                                                 Size size)
{
    //WARNING("##############inside ProcessShares::createShare()");
...
{
    //WARNING("##############inside ProcessShares::removeShares()");
...
{
    //WARNING("##############inside ProcessShares::releaseShare()");
...
{
    //WARNING("##############inside ProcessShares::readShare()");
    const Size size = m_shares.size();
